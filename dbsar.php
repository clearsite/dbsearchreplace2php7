 ...
 *
 * Version 2.2.0:
 *  - Changed to version 2.2.0 (Duh!)
 *  - Mitigated MySQLi functions for PHP7 compatibility
 *  - Fixed some Code-Linting issues.
 *
 * Version 2.1.0:
 ...
 *
 * @param array|string $table The list of tables from the $_post var to be checked.
 *
...
function icit_srdb_define_find( $filename = 'wp-config.php' ) {
    ...
    $file_content = $host = $name = $user = $pass = $char = null;
